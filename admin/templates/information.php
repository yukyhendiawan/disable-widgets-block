...
$plugin_file = WP_PLUGIN_DIR . '/disable-widgets-gb/disable-widgets-gb.php';
...
<section class="wrap">
	...
	<nav class="tabs">
		<div class="mycontainer">
			<div class="myrow">
				<div class="box-menu">
					<ul>
						<li><a myid="general" href="#general"><?php esc_html_e( 'General ', 'disable-widgets-gb' ); ?></a></li>
						<li><a myid="report" href="#report" class="active"><?php esc_html_e( 'Report ', 'disable-widgets-gb' ); ?></a></li>
						<!-- <li><a myid="changelog" href="#changelog"><?php esc_html_e( 'Changelog ', 'disable-widgets-gb' ); ?></a></li> -->
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="general data-content hide">
		<div class="mycontainer">
			<div class="myrow">
				<div class="col-left">
					<h2>
					<?php esc_html_e( 'General', 'disable-widgets-gb' ); ?>
					</h2>
					<p><?php esc_html_e( 'This plugin simplifies WordPress widget management by disabling Gutenberg widget blocks and restoring the familiar classic widget interface. Upon activation, this change is applied automatically, requiring no additional configuration. Enjoy the ease and speed of pre-Gutenberg widget management.', 'disable-widgets-gb' ); ?></p>
	...
	<section class="report data-content">
		<div class="mycontainer">
			<div class="myrow">
				<div class="col-left">
					<h2><?php esc_html_e( 'Report', 'disable-widgets-gb' ); ?></h2>

					<p><?php esc_html_e( 'If You Encounter Any Bugs or Issues While Using It, We Encourage You to Report Them to Us Immediately. Reporting Bugs is a Crucial Step in Ensuring Fast Updates and Fixes, Allowing Your Experience to Remain Smooth and Uninterrupted. Your support and feedback are invaluable in helping us maintain the quality and performance of our product.', 'disable-widgets-gb' ); ?></p>					

					<br/>

					<p><?php esc_html_e( 'Below are the steps to report a bug:', 'disable-widgets-gb' ); ?></p>

					<br/>

					<ol>
						<li>
						<?php esc_html_e( 'Identify The Bug: Please Try To Identify And Understand The Problem Or Bug You Have Encountered. Make Sure To Note The Details Of How The Bug Manifests And How It Affects The Usage.', 'disable-widgets-gb' ); ?>
						</li>

						<li><?php esc_html_e( 'Provide a Detailed Explanation: When reporting the bug to us, provide a clear and detailed explanation of the issue you encountered.', 'disable-widgets-gb' ); ?></li>

						<li><?php esc_html_e( 'Include Screenshots: To assist us in better understanding the bug, please include screenshots that illustrate the problem you encountered. This will help us analyze and resolve the issue more efficiently.', 'disable-widgets-gb' ); ?></li>

						<li>
						<?php esc_html_e( 'Contact And Report Submission: Please Reach Out To The Development Team Via Email at ', 'disable-widgets-gb' ); ?>

						<span class="email"><?php esc_html_e( 'yukyhendiawan1998@gmail.com', 'disable-widgets-gb' ); ?></span>

						<?php esc_html_e( 'Include The Information You Have Gathered About The Bug In Your Report. Ensure That You Provide Accurate Contact Details So That We Can Respond To Your Report Promptly.', 'disable-widgets-gb' ); ?>						

						<a class="support" target="_blank" href="https://wordpress.org/support/plugin/disable-widgets-block/"><?php esc_html_e( ' bug reporting link.', 'disable-widgets-gb' ); ?></a></li>
					</ol>

					<br/>

					<p><?php esc_html_e( 'Your Support And Cooperation In Reporting Bugs Are Highly Appreciated. We Will Make Every Effort To Address The Bugs As Quickly As Possible.', 'disable-widgets-gb' ); ?></p>

					<br/>

					<p><?php esc_html_e( 'Thank You For Your Attention And Participation In Reporting Bugs. We Aim To Deliver A Great And Satisfying User Experience.', 'disable-widgets-gb' ); ?></p>					

					<br/>

					<p>
						<?php esc_html_e( 'Best regards,', 'disable-widgets-gb' ); ?> <br/> 
						<?php esc_html_e( 'Development Team', 'disable-widgets-gb' ); ?>
					</p>
				</div>
				<div class="col-right ads">
				<?php
	...
	<section class="changelog data-content hide">
		<div class="mycontainer">
			<div class="myrow">
				<div class="col-left">
					<h2><?php esc_html_e( 'Changelog', 'disable-widgets-gb' ); ?></h2>
					<div class="changelog-info">
						<ul>
							<li>
								<span class="feat"></span>
								<?php esc_html_e( 'Features', 'disable-widgets-gb' ); ?>
							</li>
							<li>
								<span class="fix"></span>
								<?php esc_html_e( 'Bug Fixes', 'disable-widgets-gb' ); ?>
							</li>
							<li>
							...
							<li>
								...
								<?php esc_html_e( 'Styles', 'disable-widgets-gb' ); ?>
							</li>
							<li>
								<span class="refactor"></span>
								<?php esc_html_e( 'Code Refactoring', 'disable-widgets-gb' ); ?>
							</li>
							<li>
								<span class="perf"></span>
								<?php esc_html_e( 'Performance Improvements', 'disable-widgets-gb' ); ?>
							</li>
						</ul>
					</div>
					...
					if ( is_wp_error( $response ) ) {
						...
						if ( isset( $data['message'] ) ) {
							?>
							<p class="no-releases-found"><?php esc_html_e( 'No releases found.', 'disable-widgets-gb' ); ?></p>
							<?php
						} else {
							...
							foreach ( $data as $release ) {
								...
								<section>
									<h2>
										<?php esc_html_e( 'Version: ', 'disable-widgets-gb' ); ?> 
										<?php echo esc_html( $release['tag_name'] ); ?>
										<span>
											<?php esc_html_e( 'Released On ', 'disable-widgets-gb' ); ?>
							...
							if ( count( $data ) > $max_display ) {
								?>
								<a id="view-all-releases" target="_blank" href="https://github.com/yukyhendiawan/disable-widgets-gb/releases">
									<?php esc_html_e( 'View All Releases', 'disable-widgets-gb' ); ?>
								</a>
								<?php
							}
						}
